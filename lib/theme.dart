...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff136b55),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa3f2d7),
      ...
      onTertiaryContainer: Color(0xff284b5d),
      ...
      inversePrimary: Color(0xff88d6bb),
      primaryFixed: Color(0xffa3f2d7),
      onPrimaryFixed: Color(0xff002118),
      primaryFixedDim: Color(0xff88d6bb),
      ...
      onTertiaryFixedVariant: Color(0xff284b5d),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff136b55),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff297a64),
      ...
      outlineVariant: Color(0xff666f6b),
      shadow: Color(0xff000000),
      scrim: Color(0xff000000),
      inverseSurface: Color(0xff2c322f),
      inversePrimary: Color(0xff88d6bb),
      primaryFixed: Color(0xff297a64),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff00614c),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xff136b55),
      primaryFixed: Color(0xffa3f2d7),
      onPrimaryFixed: Color(0xff002118),
      primaryFixedDim: Color(0xff88d6bb),
      onPrimaryFixedVariant: Color(0xff00513f),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff84d2b8),
